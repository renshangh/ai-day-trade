...
from lumibot.entities import Asset, Order, SmartLimitConfig, SmartLimitPreset, TradingFee, TradingSlippage
from lumibot.strategies.strategy import Strategy
from lumibot.traders import Trader


class BackdoorButterfly0DTESmartLimit(Strategy):
    ...
    def initialize(self):
        self.log_message("Initializing BackdoorButterfly0DTESmartLimit...", color="blue")
        ...
        try:
            ...
            self.vars.smart_limit_config = SmartLimitConfig(preset=SmartLimitPreset.NORMAL)
    ...
    def _submit_butterfly_entry(self, df: pd.DataFrame):
        ...
        buy_lower = self.create_order(
            ...
            smart_limit=self.vars.smart_limit_config,
            time_in_force="day",
        )
...
if __name__ == "__main__":
    if IS_BACKTESTING:
        ...
        trading_slippage = TradingSlippage(amount=float(os.environ.get("SMART_LIMIT_SLIPPAGE", "0.05")))
        BackdoorButterfly0DTESmartLimit.backtest(
        ...
        trader = Trader()
        strategy = BackdoorButterfly0DTESmartLimit(
            quote_asset=Asset("USD", Asset.AssetType.FOREX),
        )
